...
public class retPAGE extends Composite {
	private VerticalPanel vPanel = new VerticalPanel();
	private MainView main;

	public retPAGE(MainView main){
		this.main = main;
		initWidget(this.vPanel);

		Label id = new Label("Indtast id");
		this.vPanel.add(id);
		TextBox tb = new TextBox();
		this.vPanel.add(tb);

		Button btn1 = new Button("Soeg");
		...
		Button submit = new Button("Opdater");
