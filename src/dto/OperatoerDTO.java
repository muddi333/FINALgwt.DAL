...
public class OperatoerDTO
{
	...
	int oprId;  
	/** Operatoer-type (opr_id) i omraadet 0-3. bestemmer operatoerens rolle */
	int type;   
	...
	public OperatoerDTO(int oprId, int type, String oprNavn, String ini, String cpr, String password)
	{
		this.oprId = oprId;
		this.type = type;
