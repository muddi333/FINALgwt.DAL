...
import daoInterfaces.DALException;
	...
	public class ConnectorJ implements Serializable
	{
		...
		public ConnectorJ(String server, int port, String database,
		...
		public ConnectorJ() throws InstantiationException, IllegalAccessException,
				ClassNotFoundException, SQLException
		{
			this(ConstantJ.server, ConstantJ.port, ConstantJ.database,
					ConstantJ.username, ConstantJ.password);
		}
